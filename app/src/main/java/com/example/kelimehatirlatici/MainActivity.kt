...
class MainActivity : ComponentActivity() {
        ...
        try {
            ...
            setContent {
                ...
                try {
                    ...
                    Log.e(TAG, "Composition hatası: ${e.message}", e)
                    // Hata durumunda basit bir ekran göster
                    ErrorScreen(errorMessage = e.message ?: "Bilinmeyen hata")
                }
            }
    ...
    private fun MainScreen() {
        ...
        try {
            ...
            Log.e(TAG, "❌ Ekran oluşturma hatası: ${e.message}", e)
            errorMessage = "Ekran yüklenirken hata: ${e.message}"
        }
    }
